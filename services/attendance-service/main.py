"""Attendance Service - Entry point. Port: 8005"""
...
app = FastAPI(title="Schoolify Attendance Service", version="1.0.0", lifespan=lifespan)
...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "attendance-service"}
